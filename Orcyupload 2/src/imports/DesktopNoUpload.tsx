...
function Frame4() {
  return (
    <div className="bg-[#ffde00] box-border content-stretch flex flex-col gap-[10px] items-start p-[16px] relative rounded-[8px] shrink-0">
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full">
      <div className="h-[263.167px] relative shrink-0 w-[282.374px]" data-name="IMG_3647">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImg3647} />
      </div>
      <Frame4 />
    </div>
  );
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[53px] items-center left-[578.81px] top-[103.67px] w-[282.374px]" data-name="Content">
      <Frame5 />
      <p className="font-['Cabin_Sketch:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ffde00] text-[20px] text-center w-full">No offerings uploaded yet</p>
    </div>
  );
}
...
export default function DesktopNoUpload() {
  return (
    <div className="bg-[#121212] relative size-full" data-name="Desktop / No Upload">
      <div className="absolute bg-[#121212] bottom-0 h-[60px] left-[220px] w-[1000px]" />
      <Top />
      <Content />
      <Bottom />
    </div>
