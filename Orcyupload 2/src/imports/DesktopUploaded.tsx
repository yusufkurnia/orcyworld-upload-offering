...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col font-['Cabin_Sketch:Regular',_sans-serif] gap-[8px] items-start leading-[normal] not-italic relative shrink-0 text-[#ffde00] text-[20px] text-center w-full">
