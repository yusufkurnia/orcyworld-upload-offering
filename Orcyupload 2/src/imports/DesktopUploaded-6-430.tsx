...
function Frame7() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['Cabin_Sketch:Regular',_sans-serif] gap-[8px] grow items-start leading-[normal] min-h-px min-w-px not-italic overflow-x-clip overflow-y-auto relative shrink-0 text-[#ffde00] text-[20px] text-center w-full">
...
function Content() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[53px] h-[860px] items-center left-[579px] overflow-clip top-[104px] w-[282px]" data-name="Content">
      <Frame5 />
      <Frame7 />
    </div>
  );
